 ...
 * 推荐界面下的新闻页面
 */
public class ReNewsFragment extends AbsBaseFragment{
    ...
    public static ReNewsFragment newInstance() {

        Bundle args = new Bundle();

        ReNewsFragment fragment = new ReNewsFragment();
    ...
    protected void initDatas() {
        VolleyInstance.getVolleyInstance().startRequest(MyNetUrlSet.URL_NEWS, new VolleyResult() {
            @Override
