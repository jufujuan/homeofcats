 ...
 * 推荐界面下的技术页面
 */
public class ReTeFragment extends AbsBaseFragment{
    ...
    public static ReTeFragment newInstance() {

        Bundle args = new Bundle();

        ReTeFragment fragment = new ReTeFragment();
    ...
    protected void initDatas() {
        VolleyInstance.getVolleyInstance().startRequest(MyNetUrlSet.URL_TECHNOLOGY, new VolleyResult() {
            @Override
