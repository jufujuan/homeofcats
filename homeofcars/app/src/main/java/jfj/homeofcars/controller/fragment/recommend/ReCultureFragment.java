 ...
 * 推荐界面下的文化页面
 */
public class ReCultureFragment extends AbsBaseFragment{
    ...
    public static ReCultureFragment newInstance() {

        Bundle args = new Bundle();

        ReCultureFragment fragment = new ReCultureFragment();
    ...
    protected void initDatas() {
        VolleyInstance.getVolleyInstance().startRequest(MyNetUrlSet.URL_CULTURE, new VolleyResult() {
            @Override
