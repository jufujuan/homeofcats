 ...
 */
public class ReMarketFraRVAdapter extends RecyclerView.Adapter<CommonViewHolder> {

    private MarketBean datas;
    private Context mContext;


    public ReMarketFraRVAdapter(Context context) {
        mContext = context;
    }


    public void setDatas(MarketBean datas) {
        this.datas = datas;
