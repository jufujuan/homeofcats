 ...
 */
public class ReTestCarFraRVAdapter extends RecyclerView.Adapter<CommonViewHolder> {

    private TestCarBean datas;
    private Context mContext;


    public ReTestCarFraRVAdapter(Context context) {
        mContext = context;
    }


    public void setDatas(TestCarBean datas) {
        this.datas = datas;
