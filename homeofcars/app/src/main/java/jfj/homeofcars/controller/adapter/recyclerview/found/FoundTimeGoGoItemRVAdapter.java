...
public class FoundTimeGoGoItemRVAdapter extends RecyclerView.Adapter<CommonViewHolder> {
    ...
    public FoundTimeGoGoItemRVAdapter(Context context) {
        mContext = context;
    }
    ...
    public CommonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return CommonViewHolder.getViewHolder(parent, R.layout.item_found_time_gogo_item);
    }

    @Override
    public void onBindViewHolder(final CommonViewHolder holder, final int position) {
        holder.setImg(R.id.item_found_time_gogo_item_img,datas.get(position).getImageurl(),2000,2000,ScaleType.CENTER,Config.ARGB_8888);
    }
