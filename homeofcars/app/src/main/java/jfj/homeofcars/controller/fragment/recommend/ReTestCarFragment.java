 ...
 * 推荐界面下的优创页面
 */
public class ReTestCarFragment extends AbsBaseFragment{
    ...
    public static ReTestCarFragment newInstance() {

        Bundle args = new Bundle();

        ReTestCarFragment fragment = new ReTestCarFragment();
    ...
    protected void initDatas() {
        VolleyInstance.getVolleyInstance().startRequest(MyNetUrlSet.URL_TESTCAR, new VolleyResult() {
            @Override
