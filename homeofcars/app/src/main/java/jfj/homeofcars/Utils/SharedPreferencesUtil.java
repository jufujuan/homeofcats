...
public class SharedPreferencesUtil {
     ...
     * 数据存储的XML名称
     */
    public  final static String SETTING="RecommendMore";
    /************对内方法*************/
    /**
     * 存储数据(Int)
     *
     ...
     *            对应需要存储的List<String>
     */
    public static void putIntListValue(Context context, String key,
        ...
        putIntValue(context, key + "size", size);
        for (int i = 0; i < size; i++) {
            putIntValue(context, key + i, intList.get(i));
        }
    }
    /**
     * 取出List<String>
     ...
     * @return List<String>
     */
    public static List<Integer> getIntListValue(Context context, String key) {
        List<Integer> intList = new ArrayList<Integer>();
        int size = getIntValue(context, key + "size", 0);
        //Log.d("sp", "" + size);
        for (int i = 0; i < size; i++) {
            intList.add(getIntValue(context, key + i, 0));
        }
        return intList;
    }
